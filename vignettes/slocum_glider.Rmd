...
Obviously, in actual practice, the analysit is likely to store the downloaded
...
```{r}
plot(g, which = "p", type = "p", colorby = "temperature")
```
...
```{r}
plot(g,
    which = "p", type = "p", colorby = "temperature",
...
```{r}
plot(g, which = "p", type = "p", colorby = "salinity")
```
...
```{r}
plot(g,
    which = "p", type = "p", colorby = "salinity",
...
1. “dfo-bumblebee998-2022-12-07 Time series Delayed” Accessed September 5,
   2024.
   <https://cproof.uvic.ca/deployments/dfo-bumblebee998/dfo-bumblebee998-20221207/>.
